...
out/HullComputing.jar: out/parcs.jar src/HullComputing.java src/InnerHullComputerVertex.java src/Vertex.java
	@javac -cp out/parcs.jar src/HullComputing.java src/InnerHullComputerVertex.java src/Vertex.java
